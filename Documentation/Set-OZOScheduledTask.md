...
|`Settings`|A dictionary of Task Scheduler settings. Currently supports _Compatibility_. See _Settings_, below.|
...
_Settings_ is a dictionary containing Task Scheduler settings. The current release supports `Compatibility`:
```json
{
    "Compatibility":"Win8"
}
